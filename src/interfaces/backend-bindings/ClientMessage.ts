...
export type ClientMessage =
  ...
  | { type: 'update_doc'; data: UpdateDocMessage }
  | { type: 'update_tmp_state'; data: UpdateTmpStateMessage }
  | { type: 'get_doc'; data: GetDocMessage }
  | { type: 'query_a_i'; data: QueryAIMessage };
