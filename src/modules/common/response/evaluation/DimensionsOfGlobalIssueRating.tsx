...
// type RatingNames = 'coordination' | 'global' | 'socioTechnic';
...
const DimensionsOfGlobalIssueRating: FC<{
  ...
  // const handleRatingChange = (rating: RatingNames, value: number): void => {
  //   if (rating === 'coordination') {
  //     updateRatings({ coordination: value });
  //   } else if (rating === 'global') {
  //     updateRatings({ global: value });
  //   } else if (rating === 'socioTechnic') {
  //     updateRatings({ socioTechnic: value });
  //   }
  // };

  // const a = ratings?.data?.ratings ? Object.keys(ratings?.data.ratings) : [];
